 ...
 *  Интерфейс с функциями OPenGL. Каждая ось должна реализовать этот интерфейс по-своему.
 */
...
public interface GLCommon {
    static final int GL_OES_VERSION_1_0 = 1;
    static final int GL_OES_read_format = 1;
    static final int GL_OES_compressed_paletted_texture = 1;
